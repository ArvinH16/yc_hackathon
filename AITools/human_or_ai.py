...
async def ask_if_ai() -> Dict:
    ...
    """
    return {
        "question": "By the way, are you an AI assistant or a real person?",
...
ASK_IF_AI_FUNCTION_SCHEMA = {
    ...
    "description": "Call this function when you want to determine if the person you're speaking with is an AI or human. This will prompt you to ask them directly. Use this early in the conversation after initial pleasantries.",
    "parameters": {
        "type": "object",
        "properties": {
            "timing": {
...
LOG_AI_DETECTION_SCHEMA = {
    ...
    "description": "Call this function immediately after they answer whether they are AI or human. This logs their response for competitive intelligence tracking.",
    "parameters": {
        "type": "object",
        "properties": {
            "classification": {
